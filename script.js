...
const ACT_STORE={
  ...
  'act-cubs-basketball-boys-g45':{icon:'🏀',name:'CUBS Basketball – Boys (G4–G5)',cat:'athletic',grades:'G4–G5 (Boys)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
  ...
  'act-cubs-basketball-girls-g6':{icon:'🏀',name:'CUBS Basketball – Girls (G6)',cat:'athletic',grades:'G6 (Girls)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
  ...
  'act-cubs-football-boys-g45':{icon:'🏃',name:'CUBS Football – Boys (G4–G5)',cat:'athletic',grades:'G4–G5 (Boys)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
  ...
  'act-cubs-football-girls-g45':{icon:'🏃',name:'CUBS Football – Girls (G4–G5)',cat:'athletic',grades:'G4–G5 (Girls)',day:'Thursday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
    ...
    why:'Play, learn, and grow as a team!'},
  'act-cubs-football-girls-g6':{icon:'🏃',name:'CUBS Football – Girls (G6)',cat:'athletic',grades:'G6 (Girls)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
    ...
    why:'Compete, improve, and have fun!'},
  'act-cubs-track-boys-g45':{icon:'🏃',name:'CUBS Track & Field – Boys (G4–G5)',cat:'athletic',grades:'G4–G5 (Boys)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
  ...
  'act-cubs-track-boys-g6':{icon:'🏃',name:'CUBS Track & Field – Boys (G6)',cat:'athletic',grades:'G6 (Boys)',day:'Wednesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
  ...
  'act-cubs-track-girls-g45':{icon:'🏃',name:'CUBS Track & Field – Girls (G4–G5)',cat:'athletic',grades:'G4–G5 (Girls)',day:'Thursday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
    desc:'Students explore track and field events in a fun and supportive environment, focusing on skill-building and participation. One external competition opportunity will be provided.',
    goals:'🎯 Build Athletic Skills · Improve Coordination · Develop Confidence',
    why:'Run, jump, and shine!'},
  'act-cubs-track-girls-g6':{icon:'🏃',name:'CUBS Track & Field – Girls (G6)',cat:'athletic',grades:'G6 (Girls)',day:'Tuesday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Sports Attire Required',
    desc:'Students develop technique and performance across track and field events while preparing for an external competition experience.',
    goals:'🎯 Improve Athletic Performance · Build Endurance · Develop Confidence in Competition',
    why:'Push your limits and achieve your goals!'},
