...
const ACT_STORE={
  ...
  'act-learn-swim-g35':{icon:'🏊',name:'Learn to Swim (G3–G5)',cat:'athletic',grades:'G3–G5',day:'Monday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Swimming Attire Required',
  ...
  'act-splash':{icon:'💦',name:'Splash Fun Day',cat:'athletic',grades:'G3–G5',day:'Monday',cap:'15',instructor:'AISA Staff',fee:'free',req:'Students must be able to swim',
  ...
  'act-stuco-elem':{icon:'🗳️',name:'Student Council (StuCo Club)',cat:'arts',grades:'G3–G5',day:'Thursday',cap:'—',instructor:'AISA Staff',fee:'free',
  ...
  'act-power-up':{icon:'🔋',name:'Power-Up with Affirmations',cat:'wellness',grades:'G3–G5',day:'Thursday',cap:'15',instructor:'AISA Staff',fee:'free',
